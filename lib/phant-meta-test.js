...
app.list = function(callback, offset, limit) {
  ...
  var result = _.where(this.streams, { hidden: false, flagged: false });
...
app.listByTag = function(tag, callback, offset, limit) {
  ...
  var result = _.where(this.streams, { hidden: false, flagged: false, tags: [tag] });
...
app.listByActivity = function(callback, offset, limit) {
  ...
  result = _.sortBy(result, 'last_push');
